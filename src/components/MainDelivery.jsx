...
import {stats, statusConfig} from "../data/data.js";
...
function MainDelivery() {
    ...
    const mapStats = stats.map(({id, label, value, trend, trendUp, trendLabel, icon}) => (
        <div
            ...
            <div className="flex gap-[7.6px] items-center">
                <div className="flex items-center gap-1">
                    ...
                    <p className={trendUp ? "text-[#16A34A] font-medium text-[14px] leading-5" : "text-[#DC2626] font-medium text-[14px] leading-5"}>{trend}</p>
                </div>
                ...
                <div className="p-8">
                    ...
                    <div className="px-4 dealers h-[601px] bg-white max-w-full rounded-[12px] shadow-[box-shadow: 0px 1px 2px 0px #0000000D] overflow-y-auto overflow-x-hidden">
                        ...
                        <table className="w-full">
                            <thead>
                            <tr>
                                <th className="pt-[18.5px] pb-[19.5px] pl-6 text-left font-semibold text-[14px] leading-5 tracking-[0.7px] text-[#4B5563]">Yetkazib berish ID</th>
                                ...
                                <th className="pt-[18.5px] pb-[19.5px] text-left font-semibold text-[14px] leading-5 tracking-[0.7px] text-[#4B5563]">Qabul qiluvchi</th>
